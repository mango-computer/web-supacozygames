...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 1000, intensity: 3, threshold: 3, delay: 500, stagger: 125, staggerSelector: ':scope > li', replay: false });
		...
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image.style2', { style: 'focus-image', speed: 2000, intensity: 2, threshold: 5, delay: 0, replay: false });
		onvisible.add('.image.style1', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container11', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
